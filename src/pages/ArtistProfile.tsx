...
const ArtistProfile = () => {
  ...
  const [activeTab, setActiveTab] = useState<'releases' | 'collections'>('releases');
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    size="sm"
                    className={activeTab === 'releases' ? 'border-border/50 hover:bg-primary hover:text-primary-foreground' : 'text-muted-foreground hover:text-foreground'}
                  ...
                  <Button
                    ...
                    size="sm"
                    className={activeTab === 'collections' ? 'border-border/50 hover:bg-primary hover:text-primary-foreground' : 'text-muted-foreground hover:text-foreground'}
              ...
              <Badge variant="outline" className="text-sm">
                {activeTab === 'releases' ? `${artist.stats.totalTracks} tracks` : `${artistCollections.length} collections`}
              </Badge>
            </div>
